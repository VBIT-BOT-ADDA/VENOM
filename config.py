...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/VBIT-BOT-ADDA/VENOM",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/llVAMPIRE_PROMOll")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/llVAMPIRE_PROMOll")
